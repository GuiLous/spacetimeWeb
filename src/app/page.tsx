    ...
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-starts.svg)] bg-cover px-28 py-16 ">
        ...
        <a href="" className="group flex items-center gap-3 text-left ">
          ...
          <p className="max-w-[140px] text-sm leading-snug transition-colors group-hover:text-gray-50">
        ...
        <div className="space-y-5">
          ...
          <a
            href=""
            className="inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase text-black transition-colors hover:bg-green-600"
          >
            CADASTRAR LEMBRANÇA
          </a>
        </div>
